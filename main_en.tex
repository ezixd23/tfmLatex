...
\input{chapters/02_state_of_the_art_en}
\input{chapters/03_objectives_en}
\input{chapters/04_methodology_en}
\input{chapters/05_architecture_en}
\input{chapters/06_implementation_en}
\input{chapters/07_argocd_en}
\cleardoublepage
\phantomsection
